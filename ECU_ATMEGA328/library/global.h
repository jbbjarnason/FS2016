...
#define TPS_ACCEL_ENRICH				100			// Enrichment factor of change, TPS_ACCEL_ENRICH * Change in 탎
#define TPS_CYCLE						4
...
volatile uint16_t accel_enrich;							// Acceleration enrichment for throttle position in 탎
